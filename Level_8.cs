...
{
    public partial class Level_8 : Form
    {
        Graphics g;
        const int n = 5;
        ...
        private void Level_8_Load(object sender, EventArgs e)
        {
            for (int i = 0; i < n; i++)
            {
                for (int j = 0; j < n; j++)
        ...
        private void Level_8_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (ch == 16 && ch1 == 9 && l == true && flag == true)
            {
