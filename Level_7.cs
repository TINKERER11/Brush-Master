...
namespace My_project
{
    public partial class Level_7 : Form
    {
        ...
        private void Level_7_Load(object sender, EventArgs e)
        {
            for (int i = 0; i < n; i++)
            {
                for (int j = 0; j < n; j++)
        ...
        private void Level_7_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (ch == 14 && ch1 == 11 && flag == true && a[2, 2] == 2)
            {
